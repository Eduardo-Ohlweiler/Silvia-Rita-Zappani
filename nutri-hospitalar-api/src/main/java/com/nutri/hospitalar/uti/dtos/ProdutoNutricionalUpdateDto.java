...
/**
 * Mesmos campos do cadastro, {@code ativo} de fora: ele tem o seu próprio
 * {@code PATCH /{id}/ativo}, como em fórmula láctea e em pessoa.
 *
 * <p>Composição declarada <b>por medida</b> — a medida que o rótulo usa.
 *
 ...
 */
public record ProdutoNutricionalUpdateDto(
